...
class ManorCognitiveSeederTest {
    ...
    void seedPeople_createsSharedSubgraph() {
        ...
        var configs = Map.of(
                "agent-a", new SocialConfig(List.of(), List.of(), List.of(), List.of(),
                                            List.of(new SocialConfig.Relationship("agent-b", 0.5, 0.3, 0.2)), Map.of(), null),
                "agent-b", new SocialConfig(List.of(), List.of(), List.of(), List.of(), List.of(), Map.of(), null)
                            );
    ...
    void seedPeople_createsSharedPersonNodePerCharacter() {
        ...
        var configs = Map.of(
                ...
                "agent-b", new SocialConfig(List.of(), List.of(), List.of(), List.of(),
                                            List.of(new SocialConfig.Relationship("agent-a", -0.1, 0.4, 0.6)), Map.of(), null)
                            );
    ...
    void seedPeople_overlayHasCorrectTraitsAndPad() {
        ...
        var configs = Map.of(
                "observer", new SocialConfig(List.of(), List.of(), List.of(), List.of(),
                                             List.of(new SocialConfig.Relationship("target", 0.6, 0.3, 0.5)), Map.of(), null),
                "target", new SocialConfig(List.of(), List.of(), List.of(), List.of(), List.of(), Map.of(), null)
                            );
        seeder.seedPeople(configs, "t1");
    ...
    void seedPeople_overlayLinksToSharedNode() {
        ...
        var configs = Map.of(
                "observer", new SocialConfig(List.of(), List.of(), List.of(), List.of(),
                                             List.of(new SocialConfig.Relationship("target", 0.0, 0.0, 0.0)), Map.of(), null),
                "target", new SocialConfig(List.of(), List.of(), List.of(), List.of(), List.of(), Map.of(), null)
                            );
        seeder.seedPeople(configs, "t1");
    ...
    void seedPeople_sharedNodeHasEntitylikeTrait() {
        ...
        var configs = Map.of(
                "a", new SocialConfig(List.of(), List.of(), List.of(), List.of(),
                                      List.of(new SocialConfig.Relationship("b", 0.0, 0.0, 0.0)), Map.of(), null),
                "b", new SocialConfig(List.of(), List.of(), List.of(), List.of(), List.of(), Map.of(), null)
                            );
        seeder.seedPeople(configs, "t1");
        ...
        var configs = Map.of(
                "a", new SocialConfig(List.of(), List.of(), List.of(), List.of(),
                                      List.of(new SocialConfig.Relationship("b", 0.1, 0.2, 0.3),
                                              new SocialConfig.Relationship("c", 0.4, 0.5, 0.6)), Map.of(), null),
                "b", new SocialConfig(List.of(), List.of(), List.of(), List.of(),
                                      List.of(new SocialConfig.Relationship("a", -0.1, 0.0, 0.0)), Map.of(), null),
                "c", new SocialConfig(List.of(), List.of(), List.of(), List.of(), List.of(), Map.of(), null)
                            );
        var result = seeder.seedPeople(configs, "t1");
