...
@QuarkusTest
@Tag("llm-eval")
@TestProfile(BelbinLayerTest.Profile.class)
class BelbinLayerTest {

    private static final ProfileMode PROFILE = ProfileMode.BELBIN;
    ...
    public static class Profile implements QuarkusTestProfile {
        ...
        public Map<String, String> getConfigOverrides() {
            return Map.of("manor.scenario.profile", "BELBIN",
