...
@QuarkusTest
@Tag("llm-eval")
@TestProfile(CompositeLayerTest.Profile.class)
class CompositeLayerTest {

    private static final ProfileMode PROFILE = ProfileMode.COMPOSITE;
    ...
    public static class Profile implements QuarkusTestProfile {
        ...
        public Map<String, String> getConfigOverrides() {
            return Map.of("manor.scenario.profile", "COMPOSITE",
