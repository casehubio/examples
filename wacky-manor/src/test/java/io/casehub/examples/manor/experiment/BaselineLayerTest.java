...
@QuarkusTest
@Tag("llm-eval")
@TestProfile(BaselineLayerTest.Profile.class)
class BaselineLayerTest {

    private static final ProfileMode PROFILE = ProfileMode.BASELINE;
    ...
    public static class Profile implements QuarkusTestProfile {
        ...
        public Map<String, String> getConfigOverrides() {
            return Map.of("manor.scenario.profile", "BASELINE",
    ...
    private void executeRun(int runNumber) throws Exception {
        ...
        var invocation = new io.casehub.examples.manor.agent.AgentInvocationService(agentProvider, 60, 2, 2000);
